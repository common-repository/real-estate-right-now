<?php namespace realestate\WP\Settings;
...
class SettingsFactory {
	...
	public function __construct ( $section, $field_settings ) 
	{
		...
		add_action('wptools_real_estate_right_now_pcs_render_option_page', array($this, 'process_reset_options'));
	}
	...
	{
		// Sanitize the value of the 'real_estate_right_now_fieldfeatures' field here
