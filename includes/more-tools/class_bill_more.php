<?php // namespace realestaterightnow_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "realestaterightnow_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class realestaterightnow_Bill_Minozzi_Add_Ajax_Url
{
...
$realestaterightnow_bill_minozzi_add_ajax_url = new realestaterightnow_Bill_Minozzi_Add_Ajax_Url();
class realestaterightnow_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\realestaterightnow_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\realestaterightnow_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new realestaterightnow_Bill_show_more_plugins();
// } // end namespace
class realestaterightnow_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \realestaterightnow_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new realestaterightnow_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class realestaterightnow_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new realestaterightnow_bill_install_QuietSkin();
