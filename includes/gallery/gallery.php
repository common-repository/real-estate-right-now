...
add_shortcode('gallery', 'realestaterightnow_parse_gallery_shortcode');

function realestaterightnow_parse_gallery_shortcode($atts)

{

    wp_register_script('flexslider', REALESTATERIGHTNOWURL .
